...
func New(
	...
	majorityThreshold := publicDb.GetParams().MajorityThreshold

	mc := tss.NewManagerContainer(tss.NewPostedMessageManager(publicDb, int(majorityThreshold)),
		publicDb, int(majorityThreshold),
