...
func TransferOutSynthetic() *cobra.Command {
	cmd := &cobra.Command{
		Use: "transfer-out-synthetic",
		Long: `Transfer a synthetic ERC20 or ERC721 token to another chain.
Usage:
transfer-out-synthetic [ContractType] [FromChain] [TokenAddress] [ToChain] [RecipientAddress]
