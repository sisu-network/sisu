...
func (m *KeygenProposal) GetAuthor() string {
	if m != nil {
		return m.Author
	}
	return ""
...
var fileDescriptor_3d264d872070eabf = []byte{
	...
	0x4e, 0xcc, 0x11, 0x12, 0xe3, 0x62, 0x4b, 0x2c, 0x2d, 0xc9, 0xc8, 0x2f, 0x92, 0x60, 0x54, 0x60,
	...
	0xd3, 0xb9, 0x42, 0x86, 0x84, 0x00, 0x00, 0x00,
}
...
func (m *KeygenProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Author) > 0 {
		...
		i = encodeVarintKeyGen(dAtA, i, uint64(len(m.Author)))
		i--
		dAtA[i] = 0xa
	}
