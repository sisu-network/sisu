...
func (m *MockKeeper) IsObservedTxExisted(ctx types.Context, tx *types0.ObservedTx) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsObservedTxExisted", ctx, tx)
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsObservedTxExisted indicates an expected call of IsObservedTxExisted.
func (mr *MockKeeperMockRecorder) IsObservedTxExisted(ctx, tx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsObservedTxExisted", reflect.TypeOf((*MockKeeper)(nil).IsObservedTxExisted), ctx, tx)
}
...
func (m *MockKeeper) SaveObservedTx(ctx types.Context, tx *types0.ObservedTx) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SaveObservedTx", ctx, tx)
}

// SaveObservedTx indicates an expected call of SaveObservedTx.
func (mr *MockKeeperMockRecorder) SaveObservedTx(ctx, tx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveObservedTx", reflect.TypeOf((*MockKeeper)(nil).SaveObservedTx), ctx, tx)
}
