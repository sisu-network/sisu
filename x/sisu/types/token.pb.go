...
func (m *Token) GetAddresses() []string {
	if m != nil {
		return m.Addresses
	}
	return nil
...
var fileDescriptor_a9b13da34c0411e1 = []byte{
	...
	0x65, 0x26, 0xa7, 0x4a, 0x30, 0x29, 0x30, 0x6a, 0x30, 0x07, 0x41, 0x38, 0x42, 0x52, 0x5c, 0x1c,
	0x29, 0xa9, 0xc9, 0x99, 0xb9, 0x89, 0x39, 0xc5, 0x12, 0xcc, 0x0a, 0x8c, 0x1a, 0xac, 0x41, 0x70,
	0xbe, 0x90, 0x18, 0x17, 0x5b, 0x72, 0x46, 0x62, 0x66, 0x5e, 0xb1, 0x04, 0x8b, 0x02, 0xb3, 0x06,
	0x67, 0x10, 0x94, 0x27, 0x24, 0xc3, 0xc5, 0x99, 0x98, 0x92, 0x52, 0x94, 0x5a, 0x5c, 0x9c, 0x5a,
	0x2c, 0xc1, 0x0a, 0x96, 0x42, 0x08, 0x38, 0x39, 0x9f, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c,
	...
	0xf9, 0xba, 0x79, 0xa9, 0x25, 0xe5, 0xf9, 0x45, 0xd9, 0x60, 0x8e, 0x7e, 0x05, 0x84, 0x02, 0xfb,
	0x22, 0x89, 0x0d, 0xec, 0x27, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x63, 0xc5, 0xec, 0xfa,
	0xe7, 0x00, 0x00, 0x00,
}
...
func (m *Token) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Addresses) > 0 {
		for iNdEx := len(m.Addresses) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintToken(dAtA, i, uint64(len(m.Addresses[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.Chains) > 0 {
		for iNdEx := len(m.Chains) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintToken(dAtA, i, uint64(len(m.Chains[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
