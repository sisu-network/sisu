...
var fileDescriptor_a9b13da34c0411e1 = []byte{
	...
	0xcc, 0xdc, 0xc4, 0x9c, 0x62, 0x09, 0x66, 0x05, 0x46, 0x0d, 0xd6, 0x20, 0x38, 0x5f, 0x48, 0x8c,
	...
	0xf6, 0x93, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x89, 0xd1, 0xa1, 0xa6, 0xe7, 0x00, 0x00, 0x00,
}
...
func (m *Token) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Price) > 0 {
		i -= len(m.Price)
		copy(dAtA[i:], m.Price)
		i = encodeVarintToken(dAtA, i, uint64(len(m.Price)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
