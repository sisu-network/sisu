...
func (m *TransferFailure) GetRetryNum() int64 {
	if m != nil {
		return m.RetryNum
	}
	return 0
...
var fileDescriptor_39205281c2f5d16a = []byte{
	...
	0x33, 0xf4, 0xd0, 0x0c, 0x08, 0x02, 0xab, 0x51, 0x2a, 0xe0, 0xe2, 0x47, 0x93, 0x10, 0x12, 0xe1,
	...
	0xc5, 0xc5, 0x89, 0xe9, 0xa9, 0x12, 0xcc, 0x60, 0x95, 0x30, 0xae, 0x90, 0x34, 0x17, 0x67, 0x51,
	0x6a, 0x49, 0x51, 0x65, 0x7c, 0x5e, 0x69, 0xae, 0x04, 0x8b, 0x02, 0xa3, 0x06, 0x73, 0x10, 0x07,
	0x58, 0xc0, 0xaf, 0x34, 0xd7, 0xc9, 0xf9, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f,
	0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18,
	0xa2, 0x34, 0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x41, 0x81, 0xa2,
	0x9b, 0x97, 0x5a, 0x52, 0x9e, 0x5f, 0x94, 0x0d, 0xe6, 0xe8, 0x57, 0x40, 0x28, 0xb0, 0x67, 0x92,
	0xd8, 0xc0, 0xc1, 0x63, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x8c, 0x64, 0xbd, 0x31, 0x3d, 0x01,
	0x00, 0x00,
}
...
func (m *TransferFailure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RetryNum != 0 {
		i = encodeVarintTransferFailure(dAtA, i, uint64(m.RetryNum))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Message) > 0 {
...
func (m *TransferFailure) Size() (n int) {
	...
	if m.RetryNum != 0 {
		n += 1 + sovTransferFailure(uint64(m.RetryNum))
	}
	return n
}
