...
type TransferFailure struct {
	...
	TransferRetryIds []string `protobuf:"bytes,2,rep,name=transferRetryIds,proto3" json:"transferRetryIds,omitempty"`
...
func (m *TransferFailure) GetTransferRetryIds() []string {
	if m != nil {
...
var fileDescriptor_39205281c2f5d16a = []byte{
	...
	,
}
...
func (m *TransferFailure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TransferRetryIds) > 0 {
		for iNdEx := len(m.TransferRetryIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTransferFailure(dAtA, i, uint64(len(m.TransferRetryIds[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
