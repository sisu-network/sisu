...
func (m *TransferFailure) GetUniqIds() []string {
	if m != nil {
		return m.UniqIds
	}
	return nil
...
var fileDescriptor_39205281c2f5d16a = []byte{
	...
	0x33, 0xf4, 0xd0, 0x0c, 0x08, 0x02, 0xab, 0x51, 0x8a, 0xe6, 0xe2, 0x47, 0x93, 0x10, 0x12, 0xe1,
	0x62, 0x4d, 0xce, 0x48, 0xcc, 0xcc, 0x83, 0x9a, 0x0a, 0xe1, 0x08, 0x49, 0x70, 0xb1, 0x97, 0xe6,
	0x65, 0x16, 0x7a, 0xa6, 0x14, 0x4b, 0x30, 0x29, 0x30, 0x6b, 0x70, 0x06, 0xc1, 0xb8, 0x20, 0x99,
	0xdc, 0xd4, 0xe2, 0xe2, 0xc4, 0xf4, 0x54, 0x09, 0x66, 0xb0, 0x0e, 0x18, 0xd7, 0xc9, 0xf9, 0xc4,
	...
	0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x41, 0xfe, 0xd7, 0xcd, 0x4b, 0x2d, 0x29, 0xcf, 0x2f, 0xca, 0x06,
	0x73, 0xf4, 0x2b, 0x20, 0x14, 0xd8, 0xdd, 0x49, 0x6c, 0xe0, 0x90, 0x30, 0x06, 0x04, 0x00, 0x00,
	0xff, 0xff, 0xc8, 0x4e, 0xeb, 0x95, 0x28, 0x01, 0x00, 0x00,
}
...
func (m *TransferFailure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UniqIds) > 0 {
		for iNdEx := len(m.UniqIds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.UniqIds[iNdEx])
			copy(dAtA[i:], m.UniqIds[iNdEx])
			i = encodeVarintTransferFailure(dAtA, i, uint64(len(m.UniqIds[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *TransferFailure) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UniqIds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UniqIds = append(m.UniqIds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
