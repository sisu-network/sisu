...
func (m *TransferRetry) GetTransferId() string {
	if m != nil {
		return m.TransferId
	}
	return ""
...
func (m *TransferRetry) GetNonce() int64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
var fileDescriptor_09c251ce46d2c478 = []byte{
	...
	0x28, 0xda, 0x83, 0xc0, 0x2a, 0x94, 0xdc, 0xb8, 0x78, 0x51, 0x84, 0x85, 0xe4, 0xb9, 0xb8, 0xe1,
	0xae, 0xc8, 0x4c, 0x81, 0x9a, 0xcb, 0x05, 0x13, 0xf2, 0x4c, 0x11, 0x12, 0xe1, 0x62, 0xcd, 0xcb,
	0xcf, 0x4b, 0x4e, 0x05, 0x1b, 0xce, 0x1c, 0x04, 0xe1, 0x38, 0x39, 0x9f, 0x78, 0x24, 0xc7, 0x78,
	...
	0xae, 0x3e, 0xc8, 0x93, 0xba, 0x79, 0xa9, 0x25, 0xe5, 0xf9, 0x45, 0xd9, 0x60, 0x8e, 0x7e, 0x05,
	0x84, 0x02, 0x3b, 0x30, 0x89, 0x0d, 0xec, 0x61, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6a,
	0x07, 0x2c, 0x0b, 0x0d, 0x01, 0x00, 0x00,
}
...
func (m *TransferRetry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Nonce != 0 {
		i = encodeVarintTransferRetry(dAtA, i, uint64(m.Nonce))
		i--
		dAtA[i] = 0x10
	}
	if len(m.TransferId) > 0 {
		...
		i = encodeVarintTransferRetry(dAtA, i, uint64(len(m.TransferId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TransferRetry) Size() (n int) {
	...
	if m.Nonce != 0 {
		n += 1 + sovTransferRetry(uint64(m.Nonce))
	}
	return n
}
