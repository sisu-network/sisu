...
func (m *TransferRetry) GetIndex() int64 {
	if m != nil {
		return m.Index
	}
	return 0
...
var fileDescriptor_09c251ce46d2c478 = []byte{
	...
	0xae, 0xc8, 0x4c, 0x81, 0x9a, 0xcb, 0x05, 0x13, 0xf2, 0x4c, 0x11, 0x12, 0xe1, 0x62, 0xcd, 0xcc,
	0x4b, 0x49, 0xad, 0x00, 0x1b, 0xce, 0x1c, 0x04, 0xe1, 0x38, 0x39, 0x9f, 0x78, 0x24, 0xc7, 0x78,
	...
	0x84, 0x02, 0x3b, 0x30, 0x89, 0x0d, 0xec, 0x61, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xec,
	0x5a, 0xfc, 0xf4, 0x0d, 0x01, 0x00, 0x00,
}
...
func (m *TransferRetry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Index != 0 {
		i = encodeVarintTransferRetry(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x10
	}
...
func (m *TransferRetry) Size() (n int) {
	...
	if m.Index != 0 {
		n += 1 + sovTransferRetry(uint64(m.Index))
	}
	return n
}
