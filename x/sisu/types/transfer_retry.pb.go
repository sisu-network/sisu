...
type TransferRetry struct {
	TransferRetryId string `protobuf:"bytes,1,opt,name=transferRetryId,proto3" json:"transferRetryId,omitempty"`
}
...
func (m *TransferRetry) GetTransferRetryId() string {
	if m != nil {
		return m.TransferRetryId
	}
	return ""
}
...
var fileDescriptor_09c251ce46d2c478 = []byte{
	...
	0x28, 0xda, 0x83, 0xc0, 0x2a, 0x94, 0x2c, 0xb9, 0x78, 0x51, 0x84, 0x85, 0x34, 0xb8, 0xf8, 0x4b,
	0x90, 0x05, 0x3c, 0x53, 0xa0, 0x66, 0xa3, 0x0b, 0x3b, 0x39, 0x9f, 0x78, 0x24, 0xc7, 0x78, 0xe1,
	0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70,
	0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x66, 0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae,
	0x3e, 0xc8, 0x5f, 0xba, 0x79, 0xa9, 0x25, 0xe5, 0xf9, 0x45, 0xd9, 0x60, 0x8e, 0x7e, 0x05, 0x84,
	0x02, 0xbb, 0x29, 0x89, 0x0d, 0xec, 0x47, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x90, 0xe1,
	0xa4, 0x6b, 0x00, 0x01, 0x00, 0x00,
}
...
func (m *TransferRetry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TransferRetryId) > 0 {
		i -= len(m.TransferRetryId)
		copy(dAtA[i:], m.TransferRetryId)
		i = encodeVarintTransferRetry(dAtA, i, uint64(len(m.TransferRetryId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TransferRetry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferRetryId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TransferRetryId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTransferRetry(dAtA[iNdEx:])
