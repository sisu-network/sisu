...
type TxOutMsg struct {
	...
	Data   *TxOutOld `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (m *TxOutMsg) GetData() *TxOutOld {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *TxOutOld) Reset()         { *m = TxOutOld{} }
func (m *TxOutOld) String() string { return proto.CompactTextString(m) }
func (*TxOutOld) ProtoMessage()    {}
func (*TxOutOld) Descriptor() ([]byte, []int) {
	return fileDescriptor_155b13ca5b94a7d7, []int{1}
}
func (m *TxOutOld) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TxOutOld) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TxOutOld.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TxOutOld) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxOutOld.Merge(m, src)
}
func (m *TxOutOld) XXX_Size() int {
	return m.Size()
}
func (m *TxOutOld) XXX_DiscardUnknown() {
	xxx_messageInfo_TxOutOld.DiscardUnknown(m)
}

var xxx_messageInfo_TxOutOld proto.InternalMessageInfo

func (m *TxOutOld) GetTxType() TxOutType {
	if m != nil {
		return m.TxType
	}
...
func (m *TxOutOld) GetContent() *TxOutContent {
	if m != nil {
		return m.Content
	}
	return nil
...
func (m *TxOutOld) GetInput() *TxOutInput {
	if m != nil {
		return m.Input
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TxOutOld)(nil), "types.TxOutOld")
...
var fileDescriptor_155b13ca5b94a7d7 = []byte{
	...
	,
}
...
func (m *TxOutOld) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TxOutOld) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TxOutOld) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxOutOld) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxOutOld: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxOutOld: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
