...
func (*Utxo) Descriptor() ([]byte, []int) {
	return fileDescriptor_56f943bda97d3088, []int{0}
}
...
func init() { proto.RegisterFile("sisu/utxo.proto", fileDescriptor_56f943bda97d3088) }

var fileDescriptor_56f943bda97d3088 = []byte{
	// 175 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Utxo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Index != 0 {
		i = encodeVarintUtxo(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x18
	}
	if len(m.TxHash) > 0 {
		...
		i = encodeVarintUtxo(dAtA, i, uint64(len(m.TxHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Chain) > 0 {
		i -= len(m.Chain)
		copy(dAtA[i:], m.Chain)
		i = encodeVarintUtxo(dAtA, i, uint64(len(m.Chain)))
		i--
		dAtA[i] = 0xa
	}
